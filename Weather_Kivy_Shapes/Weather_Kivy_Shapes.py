...
class LocationForm(BoxLayout):
    ...
    def show_shapes(self,shapeType='Circle'):
        print(shapeType)
        self.shape_type=Factory.ShapeCondition()
        self.shape_type.condition=shapeType
        self.shape_type.shapePositionX,self.shape_type.shapePositionY=10,10
        self.shape_type.shapeSizeX,self.shape_type.shapeSizeY=50,75
        self.clear_widgets()
        self.add_widget(self.shape_type)
        return
